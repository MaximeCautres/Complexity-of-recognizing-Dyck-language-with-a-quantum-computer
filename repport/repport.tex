...
\begin{theorem}{Substrings rejection for Dyck word of height at most 2.}
...
\begin{tproof}
    ...
    First, we can get a partition of $\mathcal{A}^2$ give in \autoref{tab:partitionDyck2} by checking if
    each pair as a substring of a word make it not a Dyck word.
    ...
    \end{table}
    \begin{itemize}
        \item The set $\mathcal{X}$. First, every couple of letter such that it contains
              ...
              height 2, the current height is bounded between 0 and 2, moreover after each
              letter the current height is even this means that both couple $cd$ and $dc$ start
              on a boundary and finish on the same one. Because $cd$ and $dc$ are going
              above and below the height at which they start, both are going outside off the
              boundary which implies the word can not be a Dyck Word of height a most 2.
              ...
              \begin{figure}[h!]
                  ...
                  \caption{Every 2 letters configuration that implies the word, whom
                      the configuration is a substring, is not a Dyck word of height 2.}
                  \label{fig:rejectDyck2}
              \end{figure}

        \item The set $\mathcal{V}$. The couple of $\mathcal{A}$ do not implies
              that the word is not a Dyck word of size 2 if each can fit inside
              the height boundaries. The \autoref{fig:donotrejectDyck2} shows that
              ...
              \begin{figure}[h!]
                  ...
                  \caption{Every 2 letters configuration that
                      can be found in a valid Dyck word of height 2.}
    ...
    A word is not a dyck word of height 2 if it include a $\pm 3$ strings.
    ...
    and \autoref{fig:p3string2piece} shows only the cases for +3 strings. In
