...
\begin{itemize}
    \item \textbf{Increasing the lower bound.} To do this, it is necessary to understand the bibliography
          ...
          way is to use already existing lower bound and translate them to \Dyck{k} with reductions.
...
and the second one is a new quantum query algorithm for \Dyck{2} and its
